...
// Uniform
	...
	for (int n = 10; n <= 10000000; n *= 10)
	{
		...
		//std::cout << "Size " << t.n << ", Time: " << t.seconds << std::endl;
		add_timing("shell_sort_1", t, "timings/uniform_ss_1_timings.csv");
	...
	for (int n = 10; n <= 1000000; n *= 10)
	{
		...
		//std::cout << "Size " << t.n << ", Time: " << t.seconds << std::endl;
		add_timing("shell_sort_2", t, "timings/uniform_ss_2_timings.csv");
	...
	for (int n = 10; n <= 100000; n *= 10)
	{
		...
		add_timing("annealing_sort_1", t, "timings/uniform_as_1_timings.csv");
	...
	for (int n = 10; n <= 1000000; n *= 10)
	{
		...
		add_timing("annealing_sort_2", t, "timings/uniform_as_2_timings.csv");
...
// Nearly Sorted
	...
	for (int n = 10; n <= 10000000; n *= 10)
	{
		...
		//std::cout << "Size " << t.n << ", Time: " << t.seconds << std::endl;
		add_timing("shell_sort_1", t, "timings/nearly_sorted_ss_1_timings.csv");
		std::cout << "Shell Sort 1 - Size: " << n << " Time: " << t.seconds << " Done" << std::endl;
	}
	...
	for (int n = 10; n <= 1000000; n *= 10)
	{
		...
		//std::cout << "Size " << t.n << ", Time: " << t.seconds << std::endl;
		add_timing("shell_sort_2", t, "timings/nearly_sorted_ss_2_timings.csv");
		std::cout << "Shell Sort 2 - Size: " << n << " Time: " << t.seconds << " Done" << std::endl;
	}
	...
	for (int n = 100000; n <= 100000; n *= 10)
	{
		...
		add_timing("annealing_sort_1", t, "timings/nearly_sorted_as_1_timings.csv");
		std::cout << "Annealing Sort 1 - Size: " << n << " Time: " << t.seconds << " Done" << std::endl;
	}
	...
	for (int n = 10; n <= 1000000; n *= 10)
	{
		...
		add_timing("annealing_sort_2", t, "timings/nearly_sorted_as_2_timings.csv");
		std::cout << "Annealing Sort 2 - Size: " << n << " Time: " << t.seconds << " Done" << std::endl;
	}
